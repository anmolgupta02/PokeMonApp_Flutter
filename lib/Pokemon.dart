...
class Pokemon {
  ...
  Pokemon.fromJson(Map<String, dynamic> json) {
    ...
    avgSpawns = json['avg_spawns'].toString();   // We changed the Data Type Double => String.
    spawnTime = json['spawn_time'];
    multipliers = json['multipliers']?.cast<double>(); // ? used for handling null instance of the value.
